          ...
          {language === "he" ? (
            <>
              <section>
                ...
                <p>
                  "שמים וארץ" (להלן: "החנות" או "אנו") מכבדת את פרטיותך ומתחייבת
                  להגן על המידע האישי שלך. מדיניות פרטיות זו מסבירה כיצד אנו
                  אוספים, משתמשים, ומגינים על המידע האישי שלך בעת שימוש באתר
                  ורכישת מוצרים.
                </p>
